document.addEventListener("DOMContentLoaded", function () {
  ...
  seeMoreBtn.addEventListener("click", () => {
      hiddenEvents.forEach((event, index) => {
          ...
          if (!supportsViewTimeline) {
              setTimeout(() => {
                  event.querySelector(".event-card").style.animation = `slideIn 0.5s ease-out ${index * 0.1}s forwards`;
              }, 10);
          }
      });
      seeMoreBtn.style.display = "none";
      seeLessBtn.style.display = "inline-block";
      seeLessBtn.style.animation = "fadeIn 0.3s ease-out";
  });

  seeLessBtn.addEventListener("click", () => {
      hiddenEvents.forEach((event) => {
          event.style.display = "none";
          event.style.animation = "fadeOut 0.3s ease-out";
      });
      seeMoreBtn.style.display = "inline-block";
      seeLessBtn.style.display = "none";
      seeMoreBtn.style.animation = "fadeIn 0.3s ease-out";
  });
  ...
  seeMoreNewsBtn.addEventListener("click", () => {
      hiddenNews.forEach((news, index) => {
          ...
          if (!supportsViewTimeline) {
              setTimeout(() => {
                  news.querySelector(".card").style.animation = `slideIn 0.5s ease-out ${index * 0.1}s forwards`;
              }, 10);
          }
      });
      seeMoreNewsBtn.style.display = "none";
      seeLessNewsBtn.style.display = "inline-block";
      seeLessNewsBtn.style.animation = "fadeIn 0.3s ease-out";
  });

  seeLessNewsBtn.addEventListener("click", () => {
      hiddenNews.forEach((news) => {
          news.style.display = "none";
          news.style.animation = "fadeOut 0.3s ease-out";
      });
      seeMoreNewsBtn.style.display = "inline-block";
      seeLessNewsBtn.style.display = "none";
      seeMoreNewsBtn.style.animation = "fadeIn 0.3s ease-out";
  });
  ...
  document.getElementById("newsletterForm").addEventListener("submit", (e) => {
      ...
      if (message) {
          ...
          message.style.color = email ? "#28a745" : "#dc3545";
  ...
  window.addEventListener("scroll", () => {
      ...
      if (window.scrollY > 50) {
          ...
          navbar.style.animation = "slideUp 0.3s ease-out";
      }
  });
  ...
  darkModeToggle.addEventListener("click", () => {
      ...
      darkModeToggle.style.animation = "rotate 0.3s ease-out";
  });
  ...
  const translations = {
      ...
      kh: {
          ...
          achievement1: "សមិទ្ធផល ១",
          achievement2: "សមិទ្ធផល ២",
          achievement3: "សមិទ្ធផល ៣",
          about: "អំពី",
          team: "ក្រុម",
          mission: "បេសកកម្ម",
          vision: "ចក្ខុវិស័យ",
